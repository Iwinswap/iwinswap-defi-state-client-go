...
This Go application serves as a client for the  DeFi State Engine. It connects to the engine's JSON-RPC endpoint to receive and process real-time DeFi protocol state updates.The client is pre-configured with all the necessary patchers and copiers to handle state diffs for multiple DeFi protocols, including Uniswap V2, Uniswap V3, and various token/pool systems.
...
1. Clone the client repo:
    `git clone https://github.com//defi-state-client-go`
